...
namespace ShiftLedger.Infrastructure.Migrations
{
    ...
    [Migration("20260723035407_V2_NotificationAlertTracking")]
    partial class V2_NotificationAlertTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftLedger.Domain.Entities.Bill", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("BillNumber"));
                    ...
                    b.Property<DateTime?>("LastUnpaidAlertAtUtc")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("ShiftLedger.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Mechanics",
                            RowVersion = new Guid("00000000-0000-0000-0000-0000000000b1")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000102"),
                            Name = "Bike Wash",
                            RowVersion = new Guid("00000000-0000-0000-0000-0000000000b2")
                        });
                });
            ...
            modelBuilder.Entity("ShiftLedger.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ShiftLedger.Domain.Entities.OrgSettings", b =>
                {
                    ...
                    b.Property<int>("UnpaidAlertDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShiftLedger.Domain.Entities.ServiceJob", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("JobNumber"));

                    b.Property<DateTime?>("LastOverdueAlertAtUtc")
                        .HasColumnType("datetime(6)");
